...
public class PassageiroNegocio {
	...
	public void criarPessoa(String nome,Long cpf,String email,String telefone,String senha,String senha2) throws ExceptionGeneric {
		if(pessoa!=null){
			pessoa.setNome(nome);
			if(isExiste(cpf))
	...
	public void salvarPessoa(String codigo) throws ExceptionGeneric {
		if(codigo.equals(codigoEmail))
			new PassageiroDAO().inserir(pessoa);
		else 
