...
public class Menu implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        w = 0.1;
        h = 0.1;
        listMenu.getItems().addAll("  Empresas",
                "  Aeroporto",
                "  Aeronove",
                "  Funcionários",
                "  Passageiros",
        ...
        Platform.runLater(() -> {
            ...
            con.loadAnchorPane(paneData, "empresas.fxml");
    ...
    private void aksiKlikListMenu(MouseEvent event) {
        ...
        switch(listMenu.getSelectionModel().getSelectedIndex()){
            ...
            case 1:{
                con.loadAnchorPane(paneData, "Aeroportos.fxml");
            }
            break;
            case 2:{
                con.loadAnchorPane(paneData,"Endereco.fxml");
            }
            break;
    ...
    private void aksiLogout(ActionEvent event) {
        Tela login = new Tela();
        login.newStage2(stage, btnLogout, "/view/login.fxml", "Login", true, StageStyle.UNDECORATED, false);
